...
function Select(props) {
    ...
    function filterSuggestions(event) {
        ...
        setSuggestions(props.options.filter((option) => option.name.toLowerCase().includes(match.toLowerCase())));
    }
    ...
    return (
        ...
        >
            {props.multiple && <input type="text" name="filterSuggestions" onChange={filterSuggestions} />}
            <InputTag
                id={props.isDatalist ? props.datalistId : props.selectId}
